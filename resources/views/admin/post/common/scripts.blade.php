...
<script>
    $(document).ready(function () {
		let position_name = "{{ isset($postDetail)  ? $postDetail->post_name : '' }}";
        positions.forEach(function(data) {
             $('#post_name').append('<option value="'+data+'" ' + ((data== position_name) ? "selected" : '') +  '>'+data.toUpperCase()+'</option>');
         });
        ...
        $('#branch').change(function() {
            ...
            let departmentId = "{{ isset($postDetail)  ? $postDetail->dept_id : old('dept_id') }}";
            ...
            if (selectedBranchId) {
                $.ajax({
                    ...
                    response.data.forEach(function(data) {
                        $('#department').append('<option ' + ((data.id == departmentId) ? "selected" : '') + ' value="'+data.id+'" >'+data.dept_name+'</option>');
                    });
                    //departmentChange();
                });
            }
